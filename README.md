...
### API <a name="api"></a>
- This app consumes this [API](https://github.com/Zuwairanajma/hello-rails-back-end.git)
...
```
  ...
  git clone https://github.com/Zuwairanajma/hello-react-front-end.git
```
...
Feel free to check the [issues page](https://github.com/Zuwairanajma/hello-react-front-end/git/issues).
